...
{
    /// <summary>
    /// Command builder and parser for DELPROPROOM command
    /// </summary>
    public static class DelPropRoomCommand
    {
        /// <summary>
        /// Builds the payload for DELPROPROOM command
        /// </summary>
        public static byte[] BuildDelPropRoomPayload(DelPropRoomPayload payload)
        {
            var cmdName = "DELPROPROOM";
        ...
        /// <summary>
        /// Parses the DELPROPROOM response
        /// </summary>
        public static void ParseDelPropRoomResp(string status, List<Protocol.Field> fields)
        {
            if (status == "SUCCESS")
            {
                return;
