...
{
    /// <summary>
    /// Command builder and parser for DELPROPDAY command
    /// </summary>
    public static class DelPropDayCommand
    {
        /// <summary>
        /// Builds the payload for DELPROPDAY command
        /// </summary>
        public static byte[] BuildDelPropDayPayload(DelPropDayRequest payload)
        {
            var cmdName = "DELPROPDAY";
            ...
            var fields = new[]
            {
                ...
                new { Id = (ushort)0x02, Type = (byte)0x01, Data = Encoding.UTF8.GetBytes(payload.Date) }
            };
        ...
        /// <summary>
        /// Parses the DELPROPDAY response
        /// </summary>
        public static void ParseDelPropDayResp(string status, List<Protocol.Field> fields)
        {
            if (status == "SUCCESS")
            {
                return;
