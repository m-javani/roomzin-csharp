...
{
    /// <summary>
    /// Command builder and parser for INCROOMAVL command
    /// </summary>
    public static class IncRoomAvlCommand
    {
        /// <summary>
        /// Builds the payload for INCROOMAVL command
        /// </summary>
        public static byte[] BuildIncRoomAvlPayload(UpdRoomAvlPayload payload)
        {
            var cmdName = "INCROOMAVL";
        ...
        /// <summary>
        /// Parses the INCROOMAVL response
        /// </summary>
        public static byte ParseIncRoomAvlResp(string status, List<Protocol.Field> fields)
        {
            if (status == "SUCCESS")
            {
